...
public class Usuario extends Thread {
    ...
    public void run() {
        try {
            ...
            JOptionPane.showMessageDialog(chat, "Conexión rehusada, servidor desconocido,\n"
            ...
            JOptionPane.showMessageDialog(chat, "Conexión rehusada, error de Entrada/Salida,\n"
     ...
     * @param mensaje
     */
    static void enviarMensaje(String cliente_receptor, String mensaje) {
        ...
        lista.add(mensaje);
        System.out.println("este es el mensaje de: " + mensaje + "  paara : " + cliente_receptor);
        try {
    ...
    public void escuchar(){
        try {
            ...
            //System.out.println(VentanaC.cal);
            if (Chat.calc != 1) {
                // System.out.println(VentanaC.cal);
                JOptionPane.showMessageDialog(chat, "La comunicación con el servidor se ha\n"
    ...
    public void ejecutar(LinkedList<String> lista) {
        ...
        switch (tipo) {
            ...
            case "NUEVO_USUARIO_CONECTADO":
                ...
                //for (int i = 2; i < lista.size(); i++)
                chat.addlista(lista.get(1));
                System.out.println("usuario lista : " + lista.get(1));
                break;
